...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "anac-pl-pp-cli",
		Short: `Anac Pl CLI — Cerca bandi, esiti e avvisi di gara della piattaforma ANAC dalla riga di comando, con dettaglio JSON, cronologia, store…`,
		Long: `Anac Pl CLI — Cerca bandi, esiti e avvisi di gara della piattaforma ANAC dalla riga di comando, con dettaglio JSON, cronologia, store…
...
Health check: run 'anac-pl-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("anac-pl-pp-cli {{ .Version }}\n")
	...
	rootCmd.AddCommand(newAvvisiCmd(flags))
	...
	rootCmd.AddCommand(newAnacSearchLocalCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newNewsPromotedCmd(flags))
	tipologieCmd := newTipologiePromotedCmd(flags)
	tipologieCmd.AddCommand(newTipologieListCmd(flags))
	tipologieCmd.AddCommand(newTipologieSchedeCmd(flags))
	rootCmd.AddCommand(tipologieCmd)
	rootCmd.AddCommand(newCpvCmd(flags))
	rootCmd.AddCommand(newCigCmd(flags))
	rootCmd.AddCommand(newCercaCmd(flags))
	rootCmd.AddCommand(newCercaAvanzataCmd(flags))
	rootCmd.AddCommand(newAffidamentiCmd(flags))
