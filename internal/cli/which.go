...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  anac-pl-pp-cli which "stale tickets"
  anac-pl-pp-cli which "bottleneck"
  anac-pl-pp-cli which --limit 1 "send message"
  anac-pl-pp-cli which                                # list the full capability index`,
